...
valid_pages = {
    "dashboard", "home", "profile", "study_pillars", "az_hub", "subjects", "mcq_quiz", "flashcards",
    ...
    "resources", "shared_notes", "mnemonics", "settings", "about", "admin_content",
}
...
if page == "auth":
    ...
    home_page(theme, get_translation, MOTIVATIONAL_QUOTES)

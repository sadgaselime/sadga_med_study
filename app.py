...
with brand_col:
    st.markdown(
        f"<div style='font-family:Syne,sans-serif;font-size:1.15rem;font-weight:900;color:{theme['text']};letter-spacing:0;'>"
        f"<span style='color:{theme['primary']};'>MedStudy</span> Oman"
        f"<span style='font-family:DM Sans,sans-serif;font-size:0.72rem;font-weight:800;color:{theme['subtext']};margin-left:10px;'>AI Clinical Study Platform</span>"
        f"</div>",
        unsafe_allow_html=True,
    )
with theme_col:
...
_nav_items = [
    ...
    ("🤖","ai_tutor","AI"), ("📊","dashboard","Dash"),
    ("⏱️","pomodoro","Timer"), ("💡","mnemonics","Memos"),
    ("📖","resources","Refs"),
]
...
if page == "auth":
    ...
    if "dashboard_page" in globals():
        ...
        st.error(f"Dashboard unavailable: {_MODULE_ERR}")
